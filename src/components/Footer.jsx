        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-5">
            ...
            <nav className="mb-6 md:mb-0">
                <ul className="flex flex-wrap text-sm">
                    <li><Link to='/' className="hover:text-gray-300 px-5 border-e">Home</Link></li>
                    <li><Link to="/galleria" className="hover:text-gray-300 px-5 border-e">Galleria</Link></li>
                    <li><Link to="/skills" className="hover:text-gray-300 px-5 border-e">Skills</Link></li>
                    <li><Link to="/mamma&papa" className="hover:text-gray-300 px-5 ">Mamma & papa'</Link></li>
                </ul>
            </nav>
        </div>
